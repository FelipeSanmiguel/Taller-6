...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    public VentanaAgregarRestaurante( VentanaPrincipal principal )
    {
        ...
        // TODO completar
        JPanel panelOrganizar = new JPanel();
        panelOrganizar.setLayout( new BorderLayout( ) );
        panelDetalles = new PanelEditarRestaurante();
        panelBotones = new PanelBotonesAgregar(this);
        
        panelOrganizar.add( panelDetalles, BorderLayout.CENTER );
        panelOrganizar.add( panelBotones, BorderLayout.SOUTH );
        
        add( panelOrganizar, BorderLayout.SOUTH );
